...
echo "==== Dependencies ===="
apt-get install gcc g++ make cmake automake autoconf libevent-dev libboost1.48-dev libboost-dev libssl-dev mono-devel pkg-config qt4-dev-tools zlibc zlib1g zlib1g-dev	
